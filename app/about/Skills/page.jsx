...
const categories = {
  Languages: [
    ...
    },
    {
      ...
      icon: <FaJs className="inline-block mr-2" />,
    },
    {
      name: "TypeScript",
      description:
    ...
    },
    {
      ...
      icon: <PiFileSqlFill className="inline-block mr-2" />,
    },
    {
      name: "PL/SQL",
      description:
  ...
  "Frameworks & Libraries": [
    ...
    },
    {
      ...
      icon: <RiNextjsLine className="inline-block mr-2" />,
    },
    {
      name: "Socket.IO",
      description:
        "Library for real-time, bidirectional communication between clients and servers.",
      icon: <SiSocketdotio className="inline-block mr-2" />,
    },
  ],
  "Web Technologies": [
    {
      ...
      icon: <FaHtml5 className="inline-block mr-2" />,
    },
    {
      name: "CSS",
      description:
    ...
    },
    {
      ...
      icon: <SiAmazonapigateway className="inline-block mr-2" />,
    },
    {
      name: "GraphQL",
      description:
        "A flexible query language for APIs that gives clients control over data.",
      icon: <SiGraphql className="inline-block mr-2" />,
    },
  ],
  Databases: [
    {
  ...
  Design: [
    {
      ...
      icon: <FaFigma className="inline-block mr-2" />,
    },
  ],
};
